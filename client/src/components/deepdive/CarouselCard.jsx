...
function CarouselCard({ index, unit, introduction, content1, content2 }) {
  return (
    <div className='relative flex-none max-w-[1080px] w-[1080px] h-full flex grow flex-col gap-8 items-center px-12 pt-12 bg-secondary-tan rounded-xl overflow-hidden'>
